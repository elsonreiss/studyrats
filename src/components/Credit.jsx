  ...
  return (
    <p className={`label flex items-center justify-center gap-1.5 flex-wrap text-center ${className}`}>
      ...
      <a
        ...
        className="inline-flex items-center gap-1.5 text-ink font-medium hover:text-brand transition-colors duration-300 group"
      >
        <svg
          viewBox="0 0 16 16"
          aria-hidden="true"
          className="w-4 h-4 fill-current transition-transform duration-500 group-hover:rotate-[360deg]"
        >
